...
with tab1:
   st.header("pH scale")
   st.image("https://s4.aconvert.com/convert/p3r68-cdx67/af2d7-k2jv7.jpg", width=500)

with tab2:
   st.header("Equipment")
   st.write ('Berikut adalah alat-alat yang dapat digunakan untuk mengukur pH suatu larutan:')
   st.image("https://s4.aconvert.com/convert/p3r68-cdx67/a7l9w-pm9is.jpg", width=350, caption='pH meter')
   st.image ('https://s4.aconvert.com/convert/p3r68-cdx67/ay8h4-t6fph.jpg',width=350, caption='pH universal')
   st.image ('https://s4.aconvert.com/convert/p3r68-cdx67/a9lc4-uwlie.jpg',width=350, caption='kertas lakmus')
